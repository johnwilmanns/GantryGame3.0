...
print(f"Average x accel = {sum(x_accel) / len(x_accel)}, highest x accel = {max(x_accel)}")
print(f"Average y accel = {sum(y_accel) / len(y_accel)}, highest y accel = {max(y_accel)}")
